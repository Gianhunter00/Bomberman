...
/** 
 * @brief Creating a new bomberman and return the pointer to it
 * 
...
/** 
 * @brief Change texture for the given bomberman
 * 
...
/** 
 * @brief Input update for the bomberman
 * 
...
/** 
 * @brief Move on level for bomberman using his blocking mask for obstacle
 * 
...
/** 
 * @brief Bomberman add unique code
